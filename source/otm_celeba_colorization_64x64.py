...
output_path = './output/CelebA_colorization_64x64/'
pretrain_path = './pretrained/CelebA_colorization_64x64/'
inception_path = './Eval/utils/output/CelebA_colorization_64x64/'
...
def Degrade(y):
    ...
    y = y.reshape(y.shape[0], 1, size, size)
    y = np.repeat(y, channels, axis=1)
